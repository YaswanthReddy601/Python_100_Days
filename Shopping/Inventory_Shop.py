    ...
    def biscuit(self):
        ...
        if self.biscuits["quantity"] >= 1:
            ...
            if self.biscuits["quantity"] >= quantity:
                ...
                print(
                    f"sorry sir, we have only {self.biscuits['quantity']} biscuits!  please wait for 5 seconds to refill the biscuits")
